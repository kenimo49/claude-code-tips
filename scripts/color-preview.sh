...
# 0. gray (all gray)
echo "0. gray"
echo -e "${G}Opus 4.5 | 📁claude-code-tips | 🔀main (scripts/context-bar.sh uncommitted, synced 12m ago) | ██░░░░░░░░ 18% of 200k tokens used${R}"
...
echo "1. orange"
C='\033[38;5;173m'
echo -e "${C}Opus 4.5${G} | 📁claude-code-tips | 🔀main (scripts/context-bar.sh uncommitted, synced 12m ago) | ${C}██${E}░░░░░░░░ ${G}18% of 200k tokens used${R}"
echo -e "${G}💬 This is good. I don't think we need to change the documentation as long as we don't say that the default color is orange el...${R}"
echo ""
